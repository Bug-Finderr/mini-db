...
class SSTable:
    ...
    def get(self, key: bytes):
        ...
        # TODO: we reopen the data file on every lookup, which is wasteful.
        # Caching the file handle would help, but it's not a bottleneck for the
        # Track C benchmark and keeping it stateless avoids handle lifecycle pain.
        self.bloom_checks += 1
